...
```dashboard:open-url
url: https://tap-gui.apjworkshop.vmwareexploreindia.com/security-analysis
```
...
```dashboard:open-url
url: https://tap-gui.apjworkshop.vmwareexploreindia.com/supply-chain/host/tap-workload/{{ session_namespace }}/source-scanner
```
